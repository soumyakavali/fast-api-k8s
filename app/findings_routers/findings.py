...
from findings_models.findings_model import Finding
router = APIRouter(prefix="/api")
db_operations = DBOperations()
db_client = db_operations.get_db_object()
...
async def get_all_findings():
    ...
    findings_collection = db_client[db_operations.db_name][db_operations.db_collection]
...
async def get_all_findings(findings_list:List[Finding]):
    ...
    findings_collection = db_client[db_operations.db_name][db_operations.db_collection]
    result = findings_collection.insert_one(findings_list.dict())
